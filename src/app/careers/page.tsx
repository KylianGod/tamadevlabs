      ...
      <Section className="pt-0">
        ...
        <div className="mt-8 space-y-4">
          {ROLES.map((role) => (
            <article
              key={role.title}
              className="glass flex flex-col gap-4 rounded-2xl p-6 md:flex-row md:items-center md:justify-between"
            >
              <div>
                <h3 className="font-semibold text-white">{role.title}</h3>
                <p className="mt-1 text-sm text-cyan-400/90">{role.type}</p>
