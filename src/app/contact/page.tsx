...
export const metadata: Metadata = {
  title: "Contact",
  description: "Get in touch with TamadevLabs for AI development, SaaS engineering, or careers.",
};
...
const CONTACT_OPTIONS = [
  ...
  },
  {
    ...
    description: "Tell us about your project and we'll respond within 1 business day.",
    action: null,
  },
];
      ...
      <Section className="pt-0">
        <div className="grid gap-8 lg:grid-cols-3">
          {CONTACT_OPTIONS.map((option) => (
            <div key={option.title} className="glass rounded-2xl p-6">
              <option.icon className="h-8 w-8 text-cyan-400" />
              <h2 className="mt-4 font-semibold text-white">{option.title}</h2>
